...
/// @param displayAfter \n
/// Type: NSInteger \n
/// Value: The delay period (minute) of notification
/// @return Returns the identifier of the scheduled notification
- (NSString *)sendLocalNotification:(NSString *)title subtitle:(NSString *)subtitle message:(NSString *)message info:(NSDictionary *)info displayAfter:(NSInteger)displayAfter API_AVAILABLE(ios(10));
